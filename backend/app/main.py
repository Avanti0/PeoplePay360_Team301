...
from app.routers import auth, employees, contracts, attendance, time_off, payroll, dashboard, working_schedules, departments
...
app.include_router(departments.job_router)
